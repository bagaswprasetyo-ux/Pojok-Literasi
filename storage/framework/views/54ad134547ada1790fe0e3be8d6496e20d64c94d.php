    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <br>
                <div>
                    <a href="<?php echo e(route('berita.create')); ?>" class="btn btn-primary btn-lg" style="margin-left: 25px">Tambah</a>
                </div>
                <br>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <th><?php echo e($item->penulis); ?></th>
                                        <th><?php echo e($item->tanggal); ?></th>
                                        <th>
                                            <a href="<?php echo e(route('berita.edit', $item->id)); ?>" class="btn btn-warning">Edit</a>
                                        </th>
                                        <th>
                                            <?php echo Form::open ([
...
<?php echo $__env->make('layouts.app_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/Data/Punya Orang/Web Kunangan/kunangan/resources/views/berita_index.blade.php ENDPATH**/ ?>