...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kontakadmin.index') }}">Kontak</a>
                    </li>
                    <li class="nav-item">
                ...
                <div id="carouselBasicExample" class="carousel slide" data-mdb-ride="carousel">
                    ...
                    <div class="carousel-inner shadow-5-strong" style="border-bottom-left-radius: 4rem">
                        <div class="carousel-item active">
                            <img src="{!! \Storage::url($banner->gambar) !!}" class="d-block w-100" alt="Literasi Kunangan Wallpaper" />
    ...
    <section>
        <div class="container">
            <div class="row row-cols-2 row-col-md-3 g-4 justify-content-center">
                @foreach ($lokasi as $item)
                    <div class="col col-md-2">
                        <div id="card-lokasi" class="card h-100 text-center">
                            <a href="{{ route('lokasidetail.show', $item->id) }}">
                                <img src="{{ asset('kunangan') }}/assets/handbg.png" class="card-img-top" alt="">
                                <div class="card-body text-black">
                                    <h5 class="card-title">{{ $item->lokasi }}</h5>
                                    <p class="card-text">{{ $item->rt }}</p>
                                </div>
                                <div></div>
                            </a>
                        </div>
    ...
    {{-- <section style="text-align: center;">
        <div class="container">
            <div class="row row-cols-2 row-cols-md-3 g-2 justify-content-center">
                @foreach ($lokasi as $item)
                    <div class="col mb-2">
                        <div id="card-lokasi" class="card text-center" style="max-width: 160px; margin: auto;">
                            <a href="{{ route('lokasidetail.show', $item->id) }}">
                                <img src="{{ asset('kunangan') }}/assets/handbg.png" class="card-img-top" alt="">
                                <div class="card-body text-black">
                                    <h5 class="card-title" style="font-size: 14px;">{{ $item->lokasi }}</h5>
                                    <p class="card-text" style="font-size: 12px;">{{ $item->rt }}</p>
                                </div>
                            </a>
                        </div>
                    </div>
    ...
    <section class="container">
        ...
        <small class="subtitle-section"> Our library's line of collection that have been favoured by our users were
            ...
            <div class="row row-cols-2 row-cols-sm-2 row-cols-md-5 g-4 mt-2 d-flex">
    ...
    <script src="{{ asset('kunangan') }}/script.js"></script>
